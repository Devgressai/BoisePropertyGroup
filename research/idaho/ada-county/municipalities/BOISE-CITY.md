...
| Field | Value |
|---|---|
| Entity id | `city:boise-city` |
| Type | CITY |
| Parent | county:ada |
| Jurisdiction | Ada County, Idaho |
| Census name | Boise City city |
| Census place FIPS | 08830 |
| Counties | Ada County |
...
|---|---:|---:|---|
| resident population | 237,963 | 2024 | Census Population Estimates, Vintage 2024 |
| resident population (census base) | 235,717 | 2020 | Census Population Estimates, Vintage 2024 (2020 base) |
| population change 2020 base to 2024 estimate | 1% | 2020-2024 | Census Population Estimates, Vintage 2024 |
...
| land-use-planning | City of Boise Planning and Development Services | VERIFIED |
...
## Claims specific to Boise City (7)
...
**Settlers Irrigation District delivers irrigation water to 13,187 acres of agricultural and urban land in western Ada County — the West Boise, Meridian and South Eagle areas — via a 20-mile canal and 95 miles of laterals.**

> Settlers Irrigation District continues to deliver irrigation water to 13,187 acres of both agricultural and urban lands located in West Boise, Meridian, and South Eagle areas.

Source: [About — Settlers Irrigation District](https://settlersirrigation.org/about)  
`settlers-district-coverage` · confidence HIGH · verified 2026-09-09

⚠️ DIFFERENTIATING: this district covers PART of Boise, Meridian and Eagle — not all of any of them, and not Kuna, Star or Garden City. Never say 'Boise is in Settlers Irrigation District'; say West Boise. The district's own stated boundary is: Diversion Dam at Ann Morrison Park on the east, south to Franklin Road, west to Star Road, north to the Lower Bench.
...
**The City of Boise has a Wildland Urban Interface Overlay (WUI-O) zoning district covering land at higher risk of wildland fire, whose provisions apply to all new structures and additions built after its effective date and to renovations that increase a structure's gross floor area by more than 49 percent.**

> The purpose of the WUI-O is to reduce the risks to human life, property, livelihoods, and wildlife within areas with higher risk of wildfire, and to recognize and clarify the respective roles of the city and property owners in the WUI-O to reduce those risks. ... The provisions of this Section 11-02-07.3.H shall apply to the following activities ... i. All new structures and additions to structures constructed in the WUI-O after the Effective Date; and ii. Renovation or modification of primary and accessory structures existing on the Effective Date that increase the gross floor area of the structure on the Effective Date by more than 49 percent.

Source: [Wildland Urban Interface Overlay — City of Boise](https://www.cityofboise.org/departments/planning-and-development-services/planning/zoning/zoning-districts/wildland-urban-interface-overlay/)  
`boise-wui-overlay-district` · confidence HIGH · verified 2026-09-09

⚠️ GENUINE BOISE-ONLY DIFFERENTIATOR and directly material to a seller of a foothills property: a buyer planning to expand a WUI-O house by more than 49% of its gross floor area triggers the overlay's construction requirements. Interior-only renovations are excepted regardless of area. ⚠️ Do NOT assert that other Ada cities have or lack an equivalent overlay — not researched.

---

**Boise participates in the National Flood Insurance Program because of significant flood threats from the Boise River, foothills gulches and several intermittent stream channels on the upper bench.**

> The City of Boise participates in the National Flood Insurance Program due to the existence of significant flood threats related to the Boise River, foothills gulches and several intermittent stream channels on the upper bench.

Source: [Floodplain Information — City of Boise](https://www.cityofboise.org/departments/planning-and-development-services/floodplain-information/)  
`boise-nfip-flood-sources` · confidence HIGH · verified 2026-09-09

⚠️ Boise's flood exposure has THREE distinct sources, not just the river. Foothills gulches and upper-bench intermittent channels affect properties nowhere near the Boise River — a useful correction to the assumption that only riverfront property floods.
...
- `boise-project-five-districts` — The Boise Project Board of Control is the operating agent for five irrigation districts — Boise-Kuna, Big Bend, Nampa & Meridian, New York and Wilder — managing facilities transferred from the U.S. Bureau of Reclamation and delivering water to their landowners.
...
- `ada-2050-projection-divergence` — COMPASS projects Ada County will reach 715,820 by 2050, but the growth is projected to be very unevenly distributed: Kuna +128.7%, Eagle +50.6%, Garden City +42.0%, Meridian +34.8%, Boise +25.8%, Star +12.3%, while unincorporated Ada County is projected to LOSE 36.0% of its population.
...
- Direct claims: **7** · unique to this entity: **2**
