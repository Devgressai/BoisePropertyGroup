...
| Type | CITY |
| Parent | county:ada |
| Jurisdiction | Ada County / Canyon County |
| Census name | Star city |
| Census place FIPS | 76870 |
| Counties | Ada County, Canyon County |
| Spans multiple counties | **YES** |

⚠️ SPANS 2 COUNTIES (Ada County, Canyon County). Never describe as wholly within Ada County. Jurisdiction-dependent facts must be qualified by which county part is meant.
...
| land-use-planning | City of Star Planning & Zoning | VERIFIED |
...
## Claims specific to Star (9)

**4 of these name no other entity** — these are what could differentiate a page.
...
> ID|16|76870|Star city|Incorporated Place|A|Ada County, Canyon County

Source: [2020 Census Place to County Relationship File — Idaho](https://www2.census.gov/geo/docs/reference/codes/files/st16_id_places.txt)  
`ada-star-spans-two-counties` · confidence HIGH · verified 2026-09-09

⚠️ Never describe Star as wholly within Ada County. Any jurisdiction-dependent statement about Star must say which county part is meant.
...
> Development within certain flood zones requires a Flood Plain Development Permit and must meet the requirements of the City's Flood Hazard Ordinance.

Source: [Planning & Zoning FAQ — City of Star, Idaho](https://staridaho.org/FAQ.aspx)  
`star-flood-zone-building-permit-question` · confidence HIGH · verified 2026-09-09

⚠️ RESOLVED — the answer was on Star's separate FAQ page, not the Planning & Zoning page. Star also directs owners to make an appointment with the planning department to have a property evaluated for flood zone location, rather than self-determining it.
...
> An original parcel of land may be divided one time, administratively, into not more than two (2) lots, parcels, or sites for transfer of ownership or development. This process does not require a public hearing, unless the City requires the applicant to plat the land division.

Source: [Planning & Zoning FAQ — City of Star, Idaho](https://staridaho.org/FAQ.aspx)  
`star-one-time-administrative-division` · confidence HIGH · verified 2026-09-09

⚠️ STAR-SPECIFIC DIFFERENTIATOR, directly useful to a land seller: a one-time, two-lot administrative split with no public hearing is a materially cheaper and faster path than a plat. ⚠️ This is STAR'S rule. Do not generalise it to the other five cities or to unincorporated Ada County — each has its own code and none has been checked.
...
Source: [Planning & Zoning FAQ — City of Star, Idaho](https://staridaho.org/FAQ.aspx)  
`star-temporary-family-living-quarters` · confidence HIGH · verified 2026-09-09

⚠️ Relevant to the manufactured-housing pillar and to inherited-property situations where a family member's unit sits on the parcel. Star-specific; not checked elsewhere.
...
- Direct claims: **9** · unique to this entity: **4**
- Has genuinely distinctive material.
