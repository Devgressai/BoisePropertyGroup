...
| Field | Value |
|---|---|
| Entity id | `city:meridian` |
| Type | CITY |
| Parent | county:ada |
| Jurisdiction | Ada County, Idaho |
| Census name | Meridian city |
| Census place FIPS | 52120 |
| Counties | Ada County |
...
|---|---:|---:|---|
| resident population | 139,740 | 2024 | Census Population Estimates, Vintage 2024 |
| resident population (census base) | 117,794 | 2020 | Census Population Estimates, Vintage 2024 (2020 base) |
| population change 2020 base to 2024 estimate | 18.6% | 2020-2024 | Census Population Estimates, Vintage 2024 |
| resident population (COMPASS estimate) | 142,830 | 2024 | COMPASS 2024 estimate |
| population by Area of City Impact | 147,420 | 2024 | COMPASS 2024 estimate |
| projected resident population | 192,540 | 2050 | COMPASS 2050 projection (based on ACI boundaries as of 2021) |
| median age | 38.7 | 2022 | U.S. Census Bureau 2022 ACS (via Ada County/COMPASS) |
...
| land-use-planning | City of Meridian Community Development — Planning Division | VERIFIED |
...
**In August 2025 the City of Meridian issued 103 new residential building permits with a stated total valuation of $23,900,907.90, and 10 new commercial permits valued at $35,391,436.00; commercial permits of all types totalled 77 permits at $67,132,621.00.**

> New TOTAL VALUE: $23,900,907.90 103 PERMITS ... New TOTAL VALUE: $35,391,436.00 10 PERMITS ... COMMERCIAL TOTAL $67,132,621.00 77 PERMITS

Source: [Building Permits for the Month, August 2025 — City of Meridian](https://meridiancity.org/media/0c1nttre/bldg-monthlypermits.pdf)  
`meridian-building-permit-activity-aug-2025` · confidence HIGH · verified 2026-09-09

⚠️ FIRST MERIDIAN-SOURCED CLAIM. meridiancity.org returns 403 to automated HTML fetches but serves its PDF assets normally, which is how this was obtained. ⚠️ SINGLE MONTH, AUGUST 2025 — a snapshot, not a trend, and it must always be labelled with its month and year. The residential/commercial attribution was verified against the report's own section headers rather than inferred from the figures. No residential grand total is stated in the report and none is asserted here.
...
- Direct claims: **7** · unique to this entity: **1**
