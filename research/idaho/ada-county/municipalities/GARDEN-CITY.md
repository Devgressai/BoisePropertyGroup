...
| Field | Value |
|---|---|
| Entity id | `city:garden-city` |
| Type | CITY |
| Parent | county:ada |
| Jurisdiction | Ada County, Idaho |
| Census name | Garden City city |
| Census place FIPS | 29620 |
| Counties | Ada County |
...
| land-use-planning | Garden City Planning Division | VERIFIED |
...
## Claims specific to Garden City (5)
...
> The Planning Division provides a wide variety of planning services for Garden City. Our services include, but are not limited to, land use entitlements such as Annexation, Zoning, Conditional Use Permits, Design Review, Signage, and Subdivisions.

Source: [Planning Services — Garden City, Idaho](https://gardencityidaho.org/departments/development-services/planning-services/)  
`gardencity-planning-scope` · confidence HIGH · verified 2026-09-09

⚠️ Annexation is listed first among Garden City's entitlements, which is notable for a small city enclosed by Boise. Not yet a differentiator on its own — needs pairing with Garden City's distinctive median age of 47.1, the oldest in the county.
...
- Direct claims: **5** · unique to this entity: **1**
