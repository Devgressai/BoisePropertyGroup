# Hidden Spring — Research Dossier
...
| Field | Value |
|---|---|
| Entity id | `city:hidden-spring` |
| Type | CENSUS_DESIGNATED_PLACE |
| Parent | county:ada |
| Jurisdiction | Ada County, Idaho |
| Census name | Hidden Spring CDP |
| Census place FIPS | 37500 |
| Counties | Ada County |
...
_No statistics recorded._

## Property administration

_No jurisdiction rows._

## Claims specific to Hidden Spring (0)
...
- `achd-city-highway-powers-abolished` — A city inside a countywide highway district may not maintain or supervise city highways, and may not levy ad valorem taxes for their construction, repair or maintenance.
...
- `ada-median-age-divergence` — Median age varies sharply across Ada County's cities: Kuna 30.2, Boise 37.9, Meridian 38.7, Star 41.4, Eagle 46.8 and Garden City 47.1, against a county median of 39.1 (2022).
...
- Direct claims: **0** · unique to this entity: **0**
- ❌ NO distinctive material. Must not receive an indexable page.
