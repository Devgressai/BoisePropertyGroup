...
export const INDUSTRIAL: CommercialPageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Meridian says so in the table itself. Its industrial standards — zero-foot front, rear and interior side setbacks, a 35-foot street setback and a 50-foot height maximum, shared by I-L and I-H — are introduced by text directing the reader to exceptions and clarifications set out elsewhere in the code. The table is not presenting itself as the answer.",
  ...
  citedClaims: [
    ...
    "meridian-industrial-table-defers-to-exceptions",
    "m3-means-three-different-things-in-ada-county",
