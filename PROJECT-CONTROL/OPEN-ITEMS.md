...
| 10 | WRITE | City content blueprints (7) | claude | Phase 2 steps 31/40/41 — not written. |
| 11 | WRITE | Master research report + machine-readable manifest | claude | Phase 2 steps 43/44 — not written. |
| 12 | REVIEW | Second-pass independent review | claude | Phase 2 step 39 — not run. |
| 13 | REVIEW | Third-pass adversarial review | claude | Phase 2 step 40 — not run. |
| 14 | REVIEW | Factual red-team + search-quality red-team | claude | Phase 2 steps 36/37 — not run. |


| 15 | UNRESEARCHED JURISDICTION | building-permits | claude | No page may state who performs this function. |
| 16 | UNVERIFIED JURISDICTION | water-rights | claude | Authority named but not sourced — cities only. |
| 17 | THIN ENTITY | Hidden Spring | claude | 0 direct claims — below the 6 needed to differentiate a page. |
| 18 | THIN ENTITY | Garden City | claude | 5 direct claims — below the 6 needed to differentiate a page. |
